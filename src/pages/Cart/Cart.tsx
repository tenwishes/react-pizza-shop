        ...
        <div className={s.container}>
            <div className={s.cart}>
                <div className={s.top}>
                    ...
                    <div className={s.clear} onClick={onClickClearCart}>
                        <svg className={s.trashcanIcon} width="20" height="20" viewBox="0 0 20 20" fill="none"
                ...
                <div className={s.bottom}>
                    ...
                    <div className={s.bottomButtons}>
                        <Link to="/" className={"button button--outline button--add" + " " + s.backButton}>
